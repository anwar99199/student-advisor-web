  ...
  const plans = [
    {
      ...
      features: [
        'استشارات أكاديمية أساسية',
        'دعم عبر البريد الإلكتروني',
        'الوصول إلى المكتبة التعليمية',
        'تقارير شهرية',
        'إرشاد في اختيار التخصص'
      ],
      popular: false,
      planId: 'basic'
    },
    {
      ...
      price: '100',
      period: 'شهرياً',
      description: 'الأفضل للطلاب الطموحين',
      features: [
        'جميع مميزات الباقة الأساسية',
        'استشارات مخصصة غير محدودة',
        'دعم عبر الدردشة المباشرة على مدار الساعة',
        'الوصول الكامل لجميع الموارد',
        'جدولة مرنة وأولوية في الحجز',
        'تقارير أس��وعية مفصلة',
        'خطة دراسية ومهنية مخصصة',
        'ورش عمل حصرية'
      ],
      popular: true,
      planId: 'premium'
